pipeline{
    ...
    stages {
        ...
        stage('Checkout from Git'){
            steps{
                git branch: 'main', credentialsId: 'github-token', url: 'https://github.com/akhtaralikhan786/starbucks-demo.git'
            }
        }
        ...
        stage('App Deploy to Docker container'){
            steps{
                sh 'docker run -d --name starbucks -p 3000:3000 akhtaralikhan171184/starbucks:latest'
            }
        }
